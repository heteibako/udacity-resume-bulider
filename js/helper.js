...
var HTMLcontactGeneric = '<li class=""><span class="orange-text">%contact%</span><span class="white-text">%data%</span></li>';
...
var HTMLonlineClasses = '<h5 class=""online-class>Online Class</h5>';
